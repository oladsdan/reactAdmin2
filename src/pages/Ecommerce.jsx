        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$65, 448.780</p>
            </div>
          </div> 
          <div className="mt-6">
            <Button 
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl
          md:w-780">
            ...
            {/* Line Chart and Stack Chart */}
            <div className="mt-10 flex gap-10 flex-wrap justify-center">
              <div className="border-r-1 border-color m-4 pr-10">
                <div>
                  <p>
                    <span className="text-3xl font-semibold">$93,438</span>
                    <span className="p-1.5 hover:drop-shadow-xl cursor-pointer text-white bg-green-400 ml-3 text-xs rounded-full">23%</span>
                  </p>
